...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `REQ-001` | `SPEC-001` | `STORY-001A` | `pending` | `ARCH-001` | `ADR-0002`; `ADR-0003` | `AGENTS.md`; `xuan-master/SKILL.md`; `xuan-master/00-entry/SKILL.md`; `enabled/SKILL.md`; `interview/SKILL.md`; `optimization/SKILL.md`; `.aries_harness/` | `file inspection of repo surfaces and artifact cross-links` | `.aries_harness/EVAL.md`; `AUDIT-001` | `n/a` |
| `REQ-001` | `SPEC-001` | `STORY-001B` | `pending` | `ARCH-001` | `ADR-0003` | `AGENTS.md`; `xuan-master/SKILL.md`; `xuan-master/00-entry/SKILL.md`; `enabled/SKILL.md`; `interview/SKILL.md` | `documentation diff and file inspection for Xuan Master / Archon / Prism alignment` | `AUDIT-001` | `pending` |
