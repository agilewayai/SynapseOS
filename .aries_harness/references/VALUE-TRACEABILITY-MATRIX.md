...
| `REQ-002` | `SPEC-002` | `STORY-002E` | `DOM-002` | `ARCH-002` | `ADR-0004` | `init/synapse_cli/installer.py`; `init/synapse_cli/adapters.py` | `generic dry-run/install smoke check`; `tests/test_synapse_cli.py` | `AUDIT-001`; `CHECKPOINT-002` | `pending` |
