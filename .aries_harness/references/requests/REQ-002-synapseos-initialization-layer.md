...
- Child refs: `SPEC-002`, `STORY-002`, `ARCH-002`, `ADR-0004`, `TRACE-001`
- Source of truth: `this file`

## Belongs Here

- Request source: operator request to add a new spec for a SynapseOS installation initialization layer
- Problem statement: SynapseOS has a clearer layered skill architecture, but installation and host onboarding are not yet a first-class layer; agent users still need a repeatable way to check prerequisites, install required runtime support, and place SynapseOS assets into supported agent hosts
...
- Success signals:
  ...
  - `synapse-cli` command expectations are explicit before implementation starts
  ...
  - future implementation slices can point to this artifact set
...
- Scope boundary: define the target initialization layer and CLI contract; implementation can follow as separate coding slices
- Constraints:
...
- Non-goals:
  - implementing the full CLI in this spec pass
...
- Runtime logs from future CLI executions
